package com.nekomu.adxero.client.models.entities;
...
public class XeroRocketModel<T extends XeroRocket> extends RocketModel<T> {
    public static final ModelLayerLocation TIER_5_LAYER = new ModelLayerLocation(new ResourceLocation(AdXero.MOD_ID, "tier_5_rocket"), "main");
    public static final ModelLayerLocation TIER_6_LAYER = new ModelLayerLocation(new ResourceLocation(AdXero.MOD_ID, "tier_6_rocket"), "main");
    public static final ModelLayerLocation TIER_7_LAYER = new ModelLayerLocation(new ResourceLocation(AdXero.MOD_ID, "tier_7_rocket"), "main");
    public static final ModelLayerLocation TIER_8_LAYER = new ModelLayerLocation(new ResourceLocation(AdXero.MOD_ID, "tier_8_rocket"), "main");
    public static final ModelLayerLocation TIER_9_LAYER = new ModelLayerLocation(new ResourceLocation(AdXero.MOD_ID, "tier_9_rocket"), "main");

    public XeroRocketModel(ModelPart root) {
        super(root);
    }

    // Tier 5-9は全て同じモデル定義を使用（Tier 4ベース）
    public static LayerDefinition createTier5Layer() {
        return createBaseTierLayer();
    }
    ...
    private static LayerDefinition createBaseTierLayer() {
    ...
    public static void register(ClientPlatformUtils.LayerDefinitionRegistry registry) {
        registry.register(TIER_5_LAYER, XeroRocketModel::createTier5Layer);
        registry.register(TIER_6_LAYER, XeroRocketModel::createTier6Layer);
        registry.register(TIER_7_LAYER, XeroRocketModel::createTier7Layer);
        registry.register(TIER_8_LAYER, XeroRocketModel::createTier8Layer);
        registry.register(TIER_9_LAYER, XeroRocketModel::createTier9Layer);
    }
}